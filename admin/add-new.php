...
<body>
    ...
    if($_POST){
        //print_r($_POST);
        $result= $database->query("select * from doctors");
        $name=$_POST['name'];
        $spec=$_POST['spec'];
        ...
        $result= $database->query("select * from doctors where docEmail='$docEmail';");
            if($result->num_rows==1){
                ...
                $sql1="insert into doctors(docEmail,hosid,doctorName,contactno,specilization,experience,gender) values('$docEmail','$hosid','$name','$tele','$spec','$experience','$gender');";
