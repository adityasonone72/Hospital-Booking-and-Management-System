                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Patients name or Email" list="patients">&nbsp;&nbsp;
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from patients where pemail='$keyword' or PatientName='$keyword' or PatientName like '$keyword%' or PatientName like '%$keyword' or PatientName like '%$keyword%' where hosid='$hosid'";
                    }else{
                        $sqlmain= "select * from patients where hosid='$hosid' order by patientid desc";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=edit&id='.$patientid.'&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Edit</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=view&id='.$patientid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">View</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$patientid.'&name='.$PatientName.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
        ...
        $action=$_GET["action"];
        if($action=='drop'){
            $PatientNameget=$_GET["PatientName"];
            echo '
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            You want to delete this record<br>('.substr($PatientNameget,0,40).').
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete-patient.php?id='.$patientid.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
                        <table width="80%" class="sub-table scrolldown add-patient-form-container" border="0">
                        <tr>
                                <td class="label-td" colspan="2">'.
                                    $errorlist[$error_1]
                                .'</td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" PatientName="PatientName" class="input-text" placeholder="Patient Name" required><br>
                                </td>
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="DOB" id="" class="box" >';
                                        
                                    echo "<option value=2001-03-03>2001-03-03</option><br/>";
                                    echo "<option value=2001-03-03>2001-03-03</option><br/>";
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        Patient ID : '.$patientid.' (Auto Generated)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                        <input type="email" name="pemail" class="input-text" placeholder="Email Address" value="'.$pemail.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="PatientName" class="input-text" placeholder="Patient Name" value="'.$PatientName.'" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="DOB" class="input-text" placeholder="Patient Name" value="'.$DOB.'" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="Phone_no" class="form-label">Telephone: </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="bg" class="input-text" placeholder="Blood Group" value="'.$bg.'" required><br>
                                        </td>
                                    </tr>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a href="patients.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
