            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <!-- <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <?php
                                        ...
                                        $list11 = $database->query("select  doctorName,docEmail from  doctors where hosid=$hosid;");
                            ...
                            <td width="15%">
                                ...
                                $patientrow = $database->query("select  * from  patients where hosid=$hosid;");
                                $doctorrow = $database->query("select  * from  doctors where hosid=$hosid;");
                                 $bedsrow = $database->query("select  * from  beds where hosid=$hosid;");
                            ...
                            <tr>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div>
                                                <div class="h1-dashboard">
                                                    <?php    echo $bedsrow->num_rows  ?>
                                                </div><br>
                                                <div class="h3-dashboard">
                                                    Beds &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                        </div>
                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/bed.svg');"></div>
                                    </div>
                                </td>
