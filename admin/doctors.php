...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from doctors where hosid='$hosid'";
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    echo "<option value=BMS>BMS</option><br/>";
                                    echo "<option value=SURGON>SURGON</option><br/>";
                                    echo "<option value=MS>MS</option><br/>";
                                    echo "<option value=Anesthesiology>Anesthesiology</option><br/>";
